...
return [
    ...
    */
    ...
    'date_equals'          => 'O campo :attribute tem de ter uma data igual a :date.',
    ...
    'gt'                   => [
        ...
        'string'  => 'O campo :attribute tem de ser maior que :value caracteres.',
        'array'   => 'O campo :attribute tem de ter mais que :value items.',
    ],
    'gte'                  => [
        'numeric' => 'O campo :attribute tem de ser maior ou igual que :value.',
        'file'    => 'O campo :attribute tem de ser maior ou igual que :value kilobytes.',
        'string'  => 'O campo :attribute tem de ser maior ou igual que :value caracteres.',
        'array'   => 'O campo :attribute tem de ser possuir :value items ou mais.',
    ],
    ...
    'lt'                   => [
        ...
        'string'  => 'O campo :attribute tem de ser menor que :value caracteres.',
        'array'   => 'O campo :attribute tem de ter menos que :value items.',
    ],
    'lte'                  => [
        'numeric' => 'O campo :attribute tem de ser menor ou igual que :value.',
        'file'    => 'O campo :attribute tem de ser menor ou igual que :value kilobytes.',
        'string'  => 'O campo :attribute tem de ser menor ou igual que :value caracteres.',
        'array'   => 'O campo :attribute tem de ter :value items ou menos.',
    ],
    'max'                  => [
    ...
    'not_regex'            => 'O campo :attribute não está no formato correto.',
    ...
    'starts_with'          => 'O campo :attribute tem de começar por: :values',
    'string'               => 'O campo :attribute deverá conter texto.',
    'timezone'             => 'O campo :attribute deverá ter um fuso horário válido.',
    'unique'               => 'O valor indicado para o campo :attribute já se encontra registado.',
    'uploaded'             => 'O upload do ficheiro :attribute falhou.',
    'url'                  => 'O formato do URL indicado para o campo :attribute é inválido.',
    'uuid'                 => 'O campo :attribute tem de possuir um UUID válido.',
